...
*/
SQLITE_DEPRECATED_WITH_REPLACEMENT("sqlite3_trace_v2", macos(10.7, 10.12),
                                   ios(5.0, 10.0), watchos(2.0, 3.0),
                                   tvos(9.0, 10.0))
SQLITE_API SQLITE_DEPRECATED void *sqlite3_trace(
    sqlite3 *, void (*xTrace)(void *, const char *), void *);

SQLITE_DEPRECATED_WITH_REPLACEMENT("sqlite3_trace_v2", macos(10.6, 10.12),
                                   ios(3.0, 10.0), watchos(2.0, 3.0),
                                   tvos(9.0, 10.0))
...
SQLITE_DEPRECATED_NO_REPLACEMENT("Not supported", macos(10.6, 10.6),
                                 ios(3.0, 3.0), watchos(2.0, 2.0),
                                 tvos(9.0, 9.0))
...
*/
SQLITE_DEPRECATED_NO_REPLACEMENT("Not supported", macos(10.6, 10.7),
                                 ios(3.0, 5.0), watchos(2.0, 2.0),
                                 tvos(9.0, 9.0))
...
*/
SQLITE_DEPRECATED_WITH_REPLACEMENT("sqlite3_soft_heap_limit64",
                                   macos(10.6, 10.7), ios(3.0, 5.0),
                                   watchos(2.0, 2.0), tvos(9.0, 9.0))
...
*/
SQLITE_DEPRECATED_NO_REPLACEMENT(
    "Process-global auto extensions are not supported on Apple platforms",
    macos(10.10, 10.10), ios(8.2, 8.2), watchos(2.0, 2.0), tvos(9.0, 9.0))
